...
// Shaders
#include "vs.ecoli.hpp"
#include "fs.ecoli.hpp"
...
DrawableEcoli::DrawableEcoli(render::Context& context)
...
void DrawableEcoli::draw(render::Context& context, RealType size, RealType budSize,
