...
/**
 * @brief Rendering object for ecoli.
 */
class DrawableEcoli
{
...
public:
     ...
     */
    explicit DrawableEcoli(render::Context& context);
...
public:
     ...
     * @param size    Ecoli size.
     * @param budSize Bud size.
     * @param color   Ecoli color.
     * @param idColor Ecoli identification color.
     */
